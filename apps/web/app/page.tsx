      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Your AI-powered daily standup assistant. Automatically generate smart, 
            human-like daily summaries from your GitHub activity—no more digging through commits and PRs.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Smart AI analyzes your commits, PRs, and issues to generate structured daily standup updates automatically.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Connect your GitHub account and we&apos;ll automatically track your daily development activity across all repositories.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">
                Share your updates to Slack, email, or export as markdown. Perfect for remote teams and async communication.
              </p>
            </div>
          </div>
        </div>
